...
import com.example.SaveMySpot.exceptionhandler.payment.PaymentException;
...
public class PaymentView {
    ...
    public Payment showPayment() {
        ...
        payment.setBookingId(Integer.parseInt(ConsoleReader.SCANNER.nextLine()));
        payment.setPaymentMethod(selectPaymentMethod());
        payment.setPaymentDate(LocalDateTime.now());
        System.out.print("Amount : ");
        payment.setAmount(BigDecimal.valueOf(Double.parseDouble(ConsoleReader.SCANNER.nextLine())));
        System.out.println("==========================================");
